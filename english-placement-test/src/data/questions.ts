...
export const speakingTasks: SpeakingTask[] = [
  ...
  },
  {
    ...
    level: "B1",
    instruction:
      "Look at the picture and describe what you see. Talk about the people, the place, and what might be happening. You have 40 seconds.",
    durationSec: 40,
...
export const allQuestions = {
  reading: [...readingMCQs, readingDropdown, readingDrag],
  listening: [...listeningMCQs],
  writing: [writingRephrase, writingShort],
